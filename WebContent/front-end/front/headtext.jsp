...
.smoke {
    top: 360px;
    position: relative;
    background-image: url('<%=request.getContextPath()%>/front-end/front/images/inPageTopBar.png');
    height: 100px;
    ...
    <section class="hero-wrap hero-wrap-2" style="background-image: url('images/33333.jpg');" data-stellar-background-ratio="0.5">
        ...
        <div class="container">
            <div class="row no-gutters slider-text align-items-end justify-content-center">
                <div class="col-md-9 ftco-animate text-center mb-4" style="height: 230px;">
